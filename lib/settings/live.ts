...
export const pendingInvalidatingKeys=new Set(['VERIFIED','AUTO_TRADE','POLL_MS','RESOLUTION','EMA_LENGTH','SLOPE_LOOKBACK','ENTRY_VALID_CANDLES','RR','RISK_PCT','RISK_BASE','MAX_DAILY_CONSECUTIVE_LOSSES','MIN_STOP_PCT','MAX_EFFECTIVE_LEVERAGE','MAX_FEE_RISK_PCT','GST_PCT','ORDER_LEVERAGE','PRICE_SOURCE']);
